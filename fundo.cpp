...
void desenhaTexturas(GLuint textura, int x1, int x2, int y1, int y2, int z1, int z2, int z3, int z4) {
...
void Paredes( GLuint texturaQuadrado1, GLuint texturaQuadrado2, GLuint texturaQuadrado3, GLuint texturaQuadrado4, GLuint texturaQuadrado5){
    desenhaTexturas(texturaQuadrado1,-8, 8,-8, 8,-10,-10,-10,-10);
    desenhaTexturas(texturaQuadrado2, 8, 8,-8, 8,-10,  0,  0,-10);
    desenhaTexturas(texturaQuadrado3,-8,-8,-8, 8,  0,-10,-10,  0);
    desenhaTexturas(texturaQuadrado4,-8, 8,-8,-8,  0,  0,-10,-10);
    desenhaTexturas(texturaQuadrado5,-8, 8, 8, 8,-10,-10,  0,  0);
}

void Floresta( GLuint texturaFloresta, GLuint texturaArvores){
    desenhaTexturas(texturaFloresta,-10, 10,-8,-8,  6,  6,-10,-10);
